...
void SID::iterate(std::function<void(std::shared_ptr<Runway>, std::shared_ptr<Fix>)> f) const {
    std::map<std::shared_ptr<Runway>, std::shared_ptr<NavNode>> runwayToWaypoint;
    std::map<std::shared_ptr<NavNode>, std::shared_ptr<NavNode>> waypointToWaypoint;
    std::multimap<std::shared_ptr<NavNode>, std::shared_ptr<NavNode>> waypointToFinal;

    auto accept = [&f] (std::shared_ptr<Runway> rw, std::shared_ptr<NavNode> fix) {
    ...
    for (auto &it: runwayToWaypoint) {
        ...
        std::shared_ptr<NavNode> curFix = waypoint;
