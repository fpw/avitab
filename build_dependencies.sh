...
if [ ! -f $OUTDIR/lib/libcurl.a ]; then
    ...
    ./configure --prefix=$OUTDIR \
        ...
        --without-openssl --without-nghttp2 --without-libpsl --disable-ldap --without-brotli --without-winidn --without-libidn2 \
        --disable-shared --disable-crypto-auth --disable-ftp --disable-telnet --disable-gopher --disable-dict --disable-imap --disable-pop3 --disable-rtsp --disable-smtp --disable-tftp
