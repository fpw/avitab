...
list(APPEND lvgl_sources
    ...
    ${CMAKE_CURRENT_LIST_DIR}/lvgl/lv_draw/lv_draw.c
    ${CMAKE_CURRENT_LIST_DIR}/lvgl/lv_draw/lv_draw_arc.c
    ${CMAKE_CURRENT_LIST_DIR}/lvgl/lv_draw/lv_draw_img.c
    ${CMAKE_CURRENT_LIST_DIR}/lvgl/lv_draw/lv_draw_label.c
    ${CMAKE_CURRENT_LIST_DIR}/lvgl/lv_draw/lv_draw_line.c
    ${CMAKE_CURRENT_LIST_DIR}/lvgl/lv_draw/lv_draw_rbasic.c
    ${CMAKE_CURRENT_LIST_DIR}/lvgl/lv_draw/lv_draw_rect.c
    ${CMAKE_CURRENT_LIST_DIR}/lvgl/lv_draw/lv_draw_triangle.c
    ${CMAKE_CURRENT_LIST_DIR}/lvgl/lv_draw/lv_draw_vbasic.c
)

list(APPEND lvgl_sources
    ${CMAKE_CURRENT_LIST_DIR}/lvgl/lv_fonts/lv_font_builtin.c
    ${CMAKE_CURRENT_LIST_DIR}/lvgl/lv_fonts/lv_font_dejavu_10.c
    ${CMAKE_CURRENT_LIST_DIR}/lvgl/lv_fonts/lv_font_dejavu_20.c
    ${CMAKE_CURRENT_LIST_DIR}/lvgl/lv_fonts/lv_font_dejavu_30.c
    ${CMAKE_CURRENT_LIST_DIR}/lvgl/lv_fonts/lv_font_dejavu_40.c
    ${CMAKE_CURRENT_LIST_DIR}/lvgl/lv_fonts/lv_font_dejavu_10_cyrillic.c
    ${CMAKE_CURRENT_LIST_DIR}/lvgl/lv_fonts/lv_font_dejavu_20_cyrillic.c
    ${CMAKE_CURRENT_LIST_DIR}/lvgl/lv_fonts/lv_font_dejavu_30_cyrillic.c
    ${CMAKE_CURRENT_LIST_DIR}/lvgl/lv_fonts/lv_font_dejavu_40_cyrillic.c
    ${CMAKE_CURRENT_LIST_DIR}/lvgl/lv_fonts/lv_font_dejavu_10_latin_sup.c
    ${CMAKE_CURRENT_LIST_DIR}/lvgl/lv_fonts/lv_font_dejavu_20_latin_sup.c
    ${CMAKE_CURRENT_LIST_DIR}/lvgl/lv_fonts/lv_font_dejavu_30_latin_sup.c
    ${CMAKE_CURRENT_LIST_DIR}/lvgl/lv_fonts/lv_font_dejavu_40_latin_sup.c
    ${CMAKE_CURRENT_LIST_DIR}/lvgl/lv_fonts/lv_font_symbol_10.c
    ${CMAKE_CURRENT_LIST_DIR}/lvgl/lv_fonts/lv_font_symbol_20.c
    ${CMAKE_CURRENT_LIST_DIR}/lvgl/lv_fonts/lv_font_symbol_30.c
    ${CMAKE_CURRENT_LIST_DIR}/lvgl/lv_fonts/lv_font_symbol_40.c
    ${CMAKE_CURRENT_LIST_DIR}/lvgl/lv_fonts/lv_font_monospace_8.c
)
...
list(APPEND lvgl_sources
    ...
    ${CMAKE_CURRENT_LIST_DIR}/lvgl/lv_misc/lv_templ.c
    ${CMAKE_CURRENT_LIST_DIR}/lvgl/lv_misc/lv_txt.c
    ${CMAKE_CURRENT_LIST_DIR}/lvgl/lv_misc/lv_ufs.c
)

list(APPEND lvgl_sources
    ${CMAKE_CURRENT_LIST_DIR}/lvgl/lv_objx/lv_arc.c
    ...
    ${CMAKE_CURRENT_LIST_DIR}/lvgl/lv_objx/lv_imgbtn.c
    ...
    ${CMAKE_CURRENT_LIST_DIR}/lvgl/lv_objx/lv_objx_templ.c
...
list(APPEND lvgl_sources
    ...
    ${CMAKE_CURRENT_LIST_DIR}/lvgl/lv_themes/lv_theme_mono.c
    ${CMAKE_CURRENT_LIST_DIR}/lvgl/lv_themes/lv_theme_nemo.c
